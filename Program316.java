...
class Program316
{
    public static void main(String arg[]) throws Exception
    {
        ...
        FileInputStream fiobj = new FileInputStream(SourceFile);  // For Read
        FileOutputStream foobj = new FileOutputStream(DestFile);  // For write

        byte Buffer[] = new byte[1024];  // Both the above method only works on Bytes Aarry.
        int iRet = 0;
