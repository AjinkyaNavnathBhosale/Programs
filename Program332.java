...
class Program332
{
    public static void main(String arg[]) throws Exception
    {
        ...
        String Tokens[] = str.split(" ");   // Break the string into Filename and Filesize.

        System.out.println("Name of file is : "+Tokens[0]);
        System.out.println("Size of file is : "+Tokens[1]);
        System.out.println("Length of Array of strings is : "+Tokens.length);
        System.out.println("Length of Array is : "+Tokens[0].length());
    }
}